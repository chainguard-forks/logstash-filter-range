...
> [!IMPORTANT]
>
> This is a supported replacement of the original [logstash-plugins/logstash-filter-range](https://github.com/logstash-plugins/logstash-filter-range) repository.
>
